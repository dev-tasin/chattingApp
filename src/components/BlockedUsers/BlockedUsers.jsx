...
const BlockedUsers = () => {
  return (
    <div className='w-[344px] h-[462px] overflow-hidden p-5 rounded-[20px] shadow-[0px_3px_3px_0px_rgba(0,0,0,0.25)] '>
        ...
        <div className='flex items-center gap-x-[10px] border-b-[1px] pb-[10px] '>
            ...
            <div className='w-full flex justify-between '>
                ...
                <div className='px-[8px] py-[3px] bg-primary rounded-[5px] text-center'>
                    <p className='font-poppins font-semibold text-[20px] text-white cursor-pointer'>Unblock</p>
                </div>
            </div>
        </div>
