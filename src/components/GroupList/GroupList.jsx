...
const GroupList = () => {
  return (
    <div className='w-[427px] h-[347px] overflow-hidden px-5 py-3 rounded-[20px] shadow-[0px_3px_3px_0px_rgba(0,0,0,0.25)] '>
        ...
        <div className='flex items-center justify-around border-b-[2px] pb-[14px] '>
        ...
        <div className='flex items-center justify-around border-b-[2px] pb-[10px] my-[15px] '>
            <div>
                <img src={groupOne} alt="#Group_Img" />
            </div>
            <div className='-ml-[14px]'>
        ...
        <div className='flex items-center justify-around pb-[14px]'>
            <div>
                <img src={groupOne} alt="#Group_Img" />
            </div>
            <div className='-ml-[14px]'>
